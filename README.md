...
The Mathematica notebooks and Excel files listed below contain data and code that are used for numerical implementations of the core model. These implementations create figures in the preprint "Maarten J. Droste, Robert Planqué, Frank J. Bruggeman - On the conditions for shifts in metabolic strategies ". The preprint can be found on bioRxiv: https://www.biorxiv.org/content/10.1101/2025.10.03.680276v1. The corresponding release can be found on Zenodo https://doi.org/10.5281/zenodo.18657623.
